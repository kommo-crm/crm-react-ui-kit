export default {
  ...
  '`@kommo-crm/tokens` is a design tokens package for Kommo CRM. It provides primitive and semantic tokens in CSS, SCSS, Less, and JS/TS formats.':
    '`@kommo-crm/tokens` es un paquete de tokens de diseño para Kommo CRM. Proporciona tokens primitivos y semánticos en formatos CSS, SCSS, Less y JS/TS.',
  ...
  'Every token has the following shape:': 'Cada token tiene la siguiente estructura:',
  'JSON': 'JSON',
