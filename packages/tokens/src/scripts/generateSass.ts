...
export function generatePrimitivesSass(collection: PrimitiveCollection): string {
  return renderGroups(collection.groups, (v) => v);
}

export function generateThemesSass(collections: ThemeCollection[]): Record<string, string> {
